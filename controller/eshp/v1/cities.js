...
import Cities from '../../../models/eshp/v1/cities';
...
class CityHandle extends AddressComponent {
    ...
    async getCityName(req) {
        ...
        try {
            ...
            console.error('get IP position failed', err);
            res.send({
                name: 'ERROR_DATA',
                message: '获取数据失败'
            });
    ...
    async getExactAddress(req, res, next) {
        try {
            ...
            console.log('get exact address info failed');
            res.send({
                name: 'ERROR_DATA',
                message: '获取精确位置信息失败'
            });
    ...
    async pois(req, res, next) {
        ...
        try {
            ...
            console.log('getpois return info failed');
            res.send({
                status: 0,
                type: 'ERROR_DATA',
                message: '获取数据失败'
