...
import StatisModel from '../../../models/eshp/statis/statis';
import UserInfoModel from '../../../models/eshp/v1/userInfo';
...
class Statis {
    ...
    async apiCount(req, res, next) {
        ...
        try {
            ...
            console.log('get current API count failed');
            res.send({
                status: 0,
                type: 'ERROR_GET_TODAY_API_COUNT',
                message: '获取当开API请求次数失败'
            });
        }
    }
    ...
    async apiAllCount(req, res, next) {
        try {
            ...
            console.log('get all API request count failed');
            res.send({
                status: 0,
    ...
    async allApiRecord(req, res, next) {
        try {
            ...
            console.log('get all API request info failed');
            res.send({
                status: 0,
    ...
    async userCount(req, res, next) {
        ...
        try {
            ...
            console.log('get today register count failed');
            res.send({
                status: 0,
    ...
    async adminCount(req, res, next) {
        ...
        try {
            ...
            console.log('get today register admin count failed');
            res.send({
                status: 0,
                type: 'ERROR_GET_ADMIN_REGISTE_COUNT',
                message: '获取当天注册管理人数失败'
            })
        }
    }
    ...
    async orderCount(req, res, next) {
        ...
        try {
            ...
            console.log('get today order count failed');
            res.send({
                status: 0,
